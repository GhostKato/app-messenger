...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "flex justify-center items-center bg-transparent rounded-full text-button hover:bg-hover focus:bg-hover border border-red transition duration-300 ease-in-out";

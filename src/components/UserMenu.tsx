...
const UserMenu: React.FC = () => {
    ...
    return (
        <div className="absolute top-[20px] left-[20px] z-[100] bg-sidebar w-[200px] h-[470px] rounded-lg flex flex-col gap-4 pt-[50px] pl-5 pr-5 border border-border shadow-custom">
